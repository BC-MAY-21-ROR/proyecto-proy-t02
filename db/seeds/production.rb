...
4.times { State.create!(name: Faker::Address.state) }
4.times { Township.create!(name: Faker::Address.city, state_id: '1') }
4.times { Town.create!(name: Faker::Address.city, township_id: '1') }
